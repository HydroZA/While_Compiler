...
namespace Parser
{
    ...
    public class LessThan : BooleanExpression
    {
        ...
        public LessThan(ArithmeticExpression a1, ArithmeticExpression a2)
        {
            this.a1 = a1;
            this.a2 = a2;
        }
    ...
    public class GreaterThan : BooleanExpression
    {
        ...
        public GreaterThan(ArithmeticExpression a1, ArithmeticExpression a2)
        {
            this.a1 = a1;
            this.a2 = a2;
        }
    ...
    public class LessThanOrEqual : BooleanExpression
    {
        public ArithmeticExpression a1, a2;

        public LessThanOrEqual(ArithmeticExpression a1, ArithmeticExpression a2)
        {
            this.a1 = a1;
            this.a2 = a2;
        }
    ...
    public class GreaterThanOrEqual : BooleanExpression
    {
        public ArithmeticExpression a1, a2;

        public GreaterThanOrEqual(ArithmeticExpression a1, ArithmeticExpression a2)
        {
            this.a1 = a1;
            this.a2 = a2;
        }
    ...
    public class NotEqual : BooleanExpression
    {
        ...
        public NotEqual(ArithmeticExpression a1, ArithmeticExpression a2)
        {
            this.a1 = a1;
            this.a2 = a2;
        }
